...
const Appointment = () => {
  ...
  const { doctors, currencySymbol, token, backendUrl } =
  ...
  const getAvilableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        // Increment Cureent Time by 30 minute
  ...
  const bookAppointment = async () => {
    ...
    const slot = selectedSlot.find((s) => s.time === slotTime);
    if (!slot) {
    ...
    docInfo && (
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700 ">
          ...
          <div className="flex items-center gap-3 w-full overflow-x-scroll mt-4 scroll-smooth ">
            {docSlots.length &&
